...
namespace OpenTibiaUnity.Core.Assets
{
    ...
    public sealed class FrameGroup
    {
        ...
        public void Serialize(IO.BinaryStream binaryWriter, sbyte startPhase, byte phasesLimit)
        {
        ...
        public void Unserialize(IO.BinaryStream binaryReader)
        {
